...
dependencies {
    implementation("org.springframework.boot:spring-boot-starter-parent:3.5.4")
    implementation("org.springframework.boot:spring-boot-maven-plugin:3.5.4")
...
dependencies {
    ...
    byteBuddyAgent("net.bytebuddy:byte-buddy-agent:1.17.5") { isTransitive = false }
}
